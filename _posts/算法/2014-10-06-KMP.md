...
<center>< src="/source/KMP/kmp1.png"></center>

发现在最后一个字符处 c 与 d 不匹配，需要调整P的位置，注意匹配的部分是**abab**。字符串"abab"的lenMax是2，因此新的j = 2，变成下面的情形：

<center>< src="/source/KMP/kmp2.png"></center>

发现 c 与 a 不匹配，此时匹配的部分是"ab",它的lenMax是0，新的j = 0，变成下面情形：

<center>< src="/source/KMP/kmp3.png"></center>

同理依次变化如下：

<center>< src="/source/KMP/kmp4.png"></center>

<center>< src="/source/KMP/kmp5.png"></center>

<center>< src="/source/KMP/kmp6.png"></center>
